...
function Cards  ({showExpenseModal,showIncomeModal,income,expense,totalBalance,resetTransactions})  {
  return (
    <div>
      ...
      <Row className='my-row'>
       ...
       >
        ...
        <Button text="Reset Balance" blue={true} onClick={resetTransactions} ></Button>
